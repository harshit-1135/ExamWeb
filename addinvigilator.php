...
die("Connection failed: " . $conn->connect_error);
        ...
        $sql = "SELECT * FROM invigilators where exam_id='$exam_id'";
   ...
   <input type="checkbox" id="menu-toggle">
    ...
    <div class="main-content">
        ...
        <main>
            ...
            <div class="page-header">
                <h1>Invigilator details</h1>
                <small>Home / Dashboard / Invigilator details</small>
            </div>
            ...
            <form action="addInvigilator.php" method="post">
                <input type="text" class="form-field animation a3" placeholder="Invigilator name" id="InvigilatorName" name="InvigilatorName">
	...
	?>
                                <tr>
                                    <td><?php echo $row['invigilator_id']?></td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="actions">
                                        <a href="deleteinvigilator.php?invigilator_id=<?php echo $row['invigilator_id']?>"><span class="fa-solid fa-trash"></span></a>
                                        </div>
                                    </td>
                                </tr>
                                <?php	
